...
CREATE TABLE NoteCategory(`notecategory_id` VARCHAR(15) NOT NULL,  `note_id` int NOT NULL,  `category_id` VARCHAR(15) NOT NULL,  PRIMARY KEY (`notecategory_id`),  FOREIGN KEY (`note_id`) REFERENCES Note(`note_id`),  FOREIGN KEY (`category_id`) REFERENCES Category(`category_id`));
CREATE TABLE NoteReminder(`notereminder_id` VARCHAR(15) NOT NULL,  `note_id` int NOT NULL,  `reminder_id` VARCHAR(15) NOT NULL,  PRIMARY KEY (`notereminder_id`),  FOREIGN KEY (`note_id`) REFERENCES Note(`note_id`),  FOREIGN KEY (`reminder_id`) REFERENCES Reminder(`reminder_id`));
CREATE TABLE UserNote(  `usernote_id` varchar(15) NOT NULL,  `user_id` VARCHAR(15) NOT NULL,  `note_id` int NOT NULL,  PRIMARY KEY (`usernote_id`),  FOREIGN KEY (`user_id`) REFERENCES User(`user_id`),  FOREIGN KEY (`note_id`) REFERENCES Note(`note_id`));
