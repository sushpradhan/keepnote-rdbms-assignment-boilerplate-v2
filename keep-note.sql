...
CREATE TABLE Category(`category_id` int NOT NULL,  `category_name` VARCHAR(45) NOT NULL,  `category_descr` VARCHAR(45) NULL,  `category_creation_date` DATE NULL,  `category_creator` VARCHAR(15) NULL,  PRIMARY KEY (`category_id`));
...
CREATE TABLE NoteCategory(`notecategory_id` VARCHAR(15) NOT NULL,  `note_id` int NOT NULL,  `category_id` int NOT NULL,  PRIMARY KEY (`notecategory_id`),  FOREIGN KEY (`note_id`) REFERENCES Note(`note_id`),  FOREIGN KEY (`category_id`) REFERENCES Category(`category_id`));
