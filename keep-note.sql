...
CREATE TABLE User(`user_id` VARCHAR(15) NOT NULL,  `user_name` VARCHAR(45) NOT NULL ,  `user_added_date` DATETIME NULL,  `user_password` VARCHAR(45) NULL,  `user_mobile` VARCHAR(15) NULL,  PRIMARY KEY (`user_id`));
...
CREATE TABLE Reminder(`reminder_id` int NOT NULL,  `reminder_name` VARCHAR(45) NOT NULL,  `reminder_descr` VARCHAR(200) NULL,  `reminder_type` VARCHAR(20) NULL,  `reminder_creation_date` DATETIME NULL,  `reminder_creator` VARCHAR(15) NULL,  PRIMARY KEY (`reminder_id`));
CREATE TABLE NoteCategory(`notecategory_id` int NOT NULL,  `note_id` int NOT NULL,  `category_id` int NOT NULL,  PRIMARY KEY (`notecategory_id`));
CREATE TABLE NoteReminder(`notereminder_id` int NOT NULL,  `note_id` int NOT NULL,  `reminder_id` int NOT NULL,  PRIMARY KEY (`notereminder_id`));
