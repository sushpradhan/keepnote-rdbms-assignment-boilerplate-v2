...
CREATE TABLE UserNote(  `usernote_id` int NOT NULL,  `user_id` VARCHAR(15) NOT NULL,  `note_id` VARCHAR(15) NOT NULL,  PRIMARY KEY (`usernote_id`),  FOREIGN KEY (`user_id`) REFERENCES User(`user_id`),  FOREIGN KEY (`note_id`) REFERENCES Note(`note_id`));
